...
def run_model_DBLP(args,seednow):
    ...
    if True:
        ...
        net = myGAT(g, hgs,len(dl.links['count'])*2+1, in_dims, args.hidden_dim, num_classes, args.num_layers,args.intalayer, heads, F.elu, args.dropout, args.dropout, args.slope, False, 0., decode=args.decoder)
        net.to(device)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--patience', type=int, default=8, help='Patience.')
    ap.add_argument('--num-layers', type=int, default=2)
    ap.add_argument('--intalayer', type=int, default=0)
    ...
    # ap.add_argument('--seedlist', type=str, default='105,102,111,107,113')
    ap.add_argument('--seedlist', type=str, default='105,102,111,107,113')
    args = ap.parse_args()
    SEED_LIST = []
